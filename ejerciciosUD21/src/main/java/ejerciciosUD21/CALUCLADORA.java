...
public class CALUCLADORA extends JFrame {
    ...
    public CALUCLADORA() {
        ...
        about.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(CALUCLADORA.this, "Esta es una calculadora simple.", "Acerca de",
    ...
    public static void main(String[] args) {
        CALUCLADORA ventana = new CALUCLADORA();
